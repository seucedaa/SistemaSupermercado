...
export class PromocionComponent implements OnInit {
  ...
  onFechaChange(type: string, event: any) {
    ...
    todas(){
      ...
      this.reporteService.getTodasPromocion(this.formattedInicio,this.formattedFin).then(response => {
        if (response && response.success) {
            this.ventas = response.data;
    ...
    generatePDF() {
      ...
      doc.setProperties({
        title: 'Clientes con Promocion',
        subject: 'Reporte de Clientes con Promociones',
        author: 'Supermercado La Colonia',
        keywords: 'promocion, supermercado',
      ...
      autoTable(doc, {
          head: [['No.', 'Persona', 'Descuento','Metodo de Pago','Venta Fecha']],
